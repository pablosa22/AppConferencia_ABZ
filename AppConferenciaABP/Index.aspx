...
<body class="text-center">
    <form runat="server">         
        ...
        <div class="container ">
            ...
            <br />                 
            <p class="mt-5 mb-3 text-muted">&copy; Desenvolvido Pela TI AçoBrazil Versão 3.7</p>             
            <asp:Label ID="lbDescricao" class="container" runat="server">Filial: 99 - Aço Brazil (Multi Filiais)</asp:Label>
        </div>
    </form>
  </body>
</html>
